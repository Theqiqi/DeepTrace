# Developer Documentation — Design Phase (v2.1.0)
...
- Function-level explanations → link `docs/api/v2.1.0/` (Modules/*.md), not duplicated here
...
| A complete program calling the library | linked to API docs | existing compilable examples | docs/api/v2.1.0/Examples/src/ (already compiled and verified) |
