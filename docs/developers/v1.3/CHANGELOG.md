...
First developer documentation version, aligned with code tag `v1.3` and the API docs `docs/api/v1.3/`.
...
- **Corresponding code versions**: deeptrace library v1.0.0, deeptrace_cli v1.0.0 (55 public APIs, see `docs/api/v1.3/`)
